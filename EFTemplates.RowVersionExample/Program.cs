/*
 * 03-10-2021
 * Демонстрация работы при одновременном изменении одной сущности разными потоками.
 * 
 ...
 * если такой записи найдено не будет, тогда будет выброшено исключение: DbUpdateConcurrencyException
 * 
 * Как воспроизвести:
